...
import 'package:speech_to_text_search/api_calling/refund_page_api.dart';
...
class _RefundState extends State<Refund> with TickerProviderStateMixin {
  ...
  List<String> _dropdownItemsQuantity = ['Unit'];
...
// Update the path
  ...
  Widget _buildSuggestionDropdown() {
    ...
    return (newItemList?.data?.length ?? 0) > 0
        ? Container(
            decoration: BoxDecoration(
              color: const Color.fromRGBO(243, 203, 71, 1),
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Declare itemId here
                  String? unit = newItemList?.data?[index].shortUnit ?? "";
                  return Column(
                    children: [
                      ListTile(
                        trailing: Text(
